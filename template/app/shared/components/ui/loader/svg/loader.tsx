...
function SvgComponent({ color, ...rest }) {
  return (
    ...
    >
      <Path
        opacity={0.6}
        d="M9.86 43.16a5.332 5.332 0 100-10.665 5.332 5.332 0 000 10.664z"
        fill={color}
      />
      <Path
        opacity={0.3}
        d="M44.165 38.43a4.628 4.628 0 100-9.255 4.628 4.628 0 000 9.255z"
        fill={color}
      />
      <Path
        opacity={0.1}
        d="M39.94 15.09a3.823 3.823 0 100-7.645 3.823 3.823 0 000 7.646z"
        fill={color}
      />
      <Path
        opacity={0.7}
      ...
      />
      <Path
        d="M26.459 12.475a6.237 6.237 0 100-12.475 6.237 6.237 0 000 12.475z"
        fill={color}
      />
    </Svg>
  )
